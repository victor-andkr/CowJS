const encode = function (e) {
          ...
          if (isFinite(e) && Math.floor(e) === e)
            if (e >= 0 && e <= 127) s(e);
              ...
              let n = e / t,
                r = e % t;
              c([
                211, n >>> 24, n >>> 16, n >>> 8, n, r >>> 24, r >>> 16, r >>> 8, r,
              ]);
            } else
            ...
            r || ((n = new ArrayBuffer(8)), (r = new DataView(n))),
              r.setFloat64(0, e),
              s(203),
              c(new Uint8Array(n));
        })(e);
  ...
  function u(e) {
    ...
    e >= 0
      ? ((n = e / t), (r = e % t))
      : (e++, (n = Math.abs(e) / t), (r = Math.abs(e) % t), (n = ~n), (r = ~r)),
